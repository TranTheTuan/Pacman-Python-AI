...
def enhancedFeatureExtractorDigit(datum):
    ...
    # Add new binary features (based on existing features)
    # go through pixel values in 'features' (DFS), count number of whitespace regions
    # add binary feature (whether there are 1 or 2 whitespace regions)
        # more than one whitespace region -> 1
        # only one whitespace region -> 0
